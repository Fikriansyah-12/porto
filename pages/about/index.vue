...
<template>
  ...
  <div class="container">
    <div
      class="bg-[#1e1e1f] py-5 md:px-12 md:py-10 text-left border border-[#383838] rounded-3xl text-amber-50 mb-5 mx-3 px-5"
    >
        ...
        >
          ...
          <div class="md:w-7/12">
            <p class="mb-3 md:mb-7 fadein-left fadeins-1">
              &nbsp; &nbsp; &nbsp; Hello everyone! My name is Fikriansyah. I am a web
              developer based in Bekasi, West Java. I have over 3 years of professional
              experience specializing in front-end web development. I am truly passionate
              about my work — to me, programming is not merely a job, but an art form that
              carries aesthetic value.
            </p>
            <p class="mb-3 fadein-left fadeins-2">
              &nbsp; &nbsp; &nbsp; My role is to create websites that are not only
              functional and user-friendly but also visually compelling. I take pride in
              adding a personal touch to every project, ensuring that each website
              captures attention and provides an intuitive user experience. My ultimate
              goal is to communicate your message and showcase your identity in the most
              creative and effective way possible. If you are interested in working
              together, please feel free to reach out through the contact information
              provided.
            </p>
          </div>
        </section>
    ...
    <div class="py-5 md:px-12 md:py-10 text-left text-amber-50 container">
      <article data-page="about">
        <header>
          <div
            class="text-2xl font-bold text-white mb-5 fadein-bot title-section flex items-center"
