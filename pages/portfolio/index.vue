      ...
      items: [
        {
          ...
          imageUrl: "hss",
          status:
            "Event olahraga hiburan yang sering diadakan oleh Holywings, salah satu grup bisnis hiburan terbesar di Indonesia.",
        ...
        },
        {
          ...
          imageUrl: "ber",
          status:
            "BerandaToko merupakan platform yang berfokus untuk memberikan solusi bagi para pelaku UMKM untuk mempermudah kegiatan jual-beli berbagai kebutuhan antara pelanggan dengan UMKM melalui WhatsApp Business platform",
          tech: "VueJS 3, Tailwind, Laravel",
          github: "null",
          demo: "https://site.berandatoko.com/",
        },
        {
          id: 3,
          name: "Hw Group",
    ...
    <article data-page="about">
      <header>
        ...
        >
          ...
          <h4
            class="text-base mb-5 font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-amber-300"
          >
              ...
              >
                ...
                >
                  <img
                    ...
                    :src="'/images/image/' + item.imageUrl + '.png'"
                  />
                </div>
                <div class="w-full flex flex-col gap-2 text-sm md:text-base lg:text-lg">
